...
I used a combination of color and gradient thresholds to generate a binary image in `perspective_transfrom_2.py`).  Here's an example of my output for this step.  (note: this is not actually from one of the test images)
